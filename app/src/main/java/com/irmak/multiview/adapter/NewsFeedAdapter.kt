package com.irmak.multiview.adapter
...
import com.irmak.multiview.R
import com.irmak.multiview.model.NewsFeedModel
import de.hdodenhof.circleimageview.CircleImageView
import fm.jiecao.jcvideoplayer_lib.JCVideoPlayerSimple

class NewsFeedAdapter(val context: Context, val list: ArrayList<NewsFeedModel>) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is ViewHolder) {
            ...
            if (model.viewType == 3){
                ...
                VideoAdd(model.postVideoUrl, holder)
            }
        }
    }
    private fun VideoAdd(path:String,holder:ViewHolder){
